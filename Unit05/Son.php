			...
			<?php
				...
				if(isset($_POST['submit']))
				{
				    ...
				    if($response->success == true)
				    {
				        ...
				        echo '<legend style="text-align: center;padding-top: 30px;">THÔNG TIN KHÁCH HÀNG</legend>
							...
							<div class="form-group">
							 ...
							 <button type="submit" class="btn btn-primary info">Save</button>
				        	 <a href="checkInfo.php" class="btn btn-danger">Buy</a>
